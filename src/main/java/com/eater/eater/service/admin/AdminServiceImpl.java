...
public class AdminServiceImpl implements AdminService {
    ...
    public AdminServiceImpl(CourierRepository courierRepository, ClientRepository clientRepository, AdminRepository adminRepository, RestaurantOwnerRepository restaurantOwnerRepository, AdminSecurity adminSecurity) {
