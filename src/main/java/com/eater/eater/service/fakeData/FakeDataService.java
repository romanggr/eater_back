package com.eater.eater.service.fakeData;
...
//            restaurant.setLongitude(faker.number().randomDouble(6, -180, 180));
        ...
        return restaurantOwnerRepository.saveAll(restaurantOwners);
    }

    public void generateFakeData() {
        generateFakeAdmins(5);
        generateFakeClients(5);
        getFakeCouriers(5);
        generateFakeRestaurantOwners(5);
    }
}
