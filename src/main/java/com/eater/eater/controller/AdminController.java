...
//import com.eater.eater.service.auth.AuthService11;
...
//    public ResponseEntity<AuthResponse<AdminDTO>> updateAdmin(@RequestBody UpdateAdminRequest request) {
//        AuthResponse<AdminDTO> response = authService11.updateAdmin(request);
//        return ResponseEntity.ok(response);
//    }
//
//    // update password
...
//        AuthResponse<AdminDTO> response = authService11.updateAdminPassword(request);
//        return ResponseEntity.ok(response);
//    }
//
//
